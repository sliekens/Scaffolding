...
namespace Microsoft.DotNet.Tools.Scaffold.Flow
{
    ...
    {
        internal const string ScaffoldToolFolder = nameof(ScaffoldToolFolder);
        internal const string ScaffolderCommand = nameof(ScaffolderCommand);
        internal const string ScaffolderCommandParseResult = nameof(ScaffolderCommandParseResult);
        internal const string ScaffolderCommandName = nameof(ScaffolderCommandName);
        internal const string ScaffolderCommandString = nameof(ScaffolderCommandString);
        ...
        internal const string MvcScaffolderTemplate = nameof(MvcScaffolderTemplate);
        ...
        internal const string ExistingClassType = nameof(ExistingClassType);
        ...
        internal const string DbContextClassDisplayName = "DbContext Class";
    }
}
