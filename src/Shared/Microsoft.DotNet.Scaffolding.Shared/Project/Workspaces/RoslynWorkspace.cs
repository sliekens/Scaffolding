...
namespace Microsoft.DotNet.Scaffolding.Shared.Project.Workspaces
{
    public class RoslynWorkspace : Workspace
    {
            ...
            : base(MefHostServices.DefaultHost, "Custom")
        {
            ...
            var id = AddProject(projectInformation);
        ...
        private ProjectId AddProject(ProjectReferenceInformation referenceInfo)
        {
        ...
        private ProjectId AddProject(IProjectContext context)
        {
